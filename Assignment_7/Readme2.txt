...
6. Home page Design - HTML to React Convert 
  > class to className 
  > src="" to src={require('').default} & alt="" No Image in alt
  > Images folder must be named something else "Assets"